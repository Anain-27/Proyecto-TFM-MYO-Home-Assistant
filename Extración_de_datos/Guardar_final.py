...
def data_worker(mode, seconds, collect, pos_buscada):
    ...
    #Ana: Comenzamos con tiempo = 0 puesto que se captan datos inicialmente que descartaremos hasta que entre en el bucle
    tiempo = 0

    #Ana: Para
    global vuelta

    # Ana: Guardo los datos EMG, IMU y de Pose
    myo_emg_data = []
    myo_imu_data = []
    myo_pose_data = []
    ...
    # Ana: Captamos los datos del EMG
...
if __name__ == '__main__':
    ...
    myo_emg_cols = ["Tiempo", "Channel_1", "Channel_2", "Channel_3", "Channel_4", "Channel_5", "Channel_6", "Channel_7",
                    "Channel_8"]
    myo_imu_cols = ["Tiempo", "quat1", "quat2", "quat3", "quat4", "acc1", "acc2", "acc3", "gyro1", "gyro2",
                    "gyro3"]
    myo_pose_cols = ["Tiempo", "pose"]

    save(emg, myo_emg_cols, file_name, "EMG")
    save(imu, myo_imu_cols, file_name, "IMU")
    save(pose, myo_pose_cols, file_name, "Pose")
