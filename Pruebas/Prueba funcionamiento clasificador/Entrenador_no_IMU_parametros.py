...
data_file = os.path.join(path, 'Datos_5000_8_gestos_SIN_TRES.xlsx')
...
# Guardar el scaler
scaler_path = os.path.join(path_out, 'Escaladores\\scaler_5000_no_IMU_8_SIN_TRES.pkl')
...
model_path = os.path.join(path_out, 'Clasificadores\\clasificador_5000_no_IMU_8_SIN_TRES_param.pkl')
