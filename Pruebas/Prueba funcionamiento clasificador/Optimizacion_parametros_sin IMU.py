...
# Guardar el scaler
scaler_path = os.path.join(path_out, 'Escaladores\\scaler_5000_8_SIN_TRES_param.pkl')
...
model_path = os.path.join(path_out, 'Clasificadores\\clasificador_5000_8_SIN_TRES_param.pkl')
