...
# Guardar el scaler
scaler_path = os.path.join(path_out, 'Escaladores\\scaler_50000_no_IMU_8_TRES.pkl')
...
model_path = os.path.join(path_out, 'Clasificadores\\clasificador_50000_no_IMU_8_SIN_TRES_mejores.pkl')
