...
if not files:
    ...
    label_size = 10000  # Cambia este valor según lo que necesites

    # Especificar las etiquetas que deseas incluir
    etiquetas_deseadas = ['FIST', 'REST', 'UNO']  # Cambia esto a las etiquetas que necesites
    ...
    output_file = os.path.join(path_out, f'Datos_{label_size}.xlsx')
