...
data_file = os.path.join(path, 'Datos_capa_dispositivos.xlsx')
...
# Guardar el scaler
scaler_path = os.path.join(path_out, 'Escaladores\\scaler_5000_capa_dispositivos_param.pkl')
...
model_path = os.path.join(path_out, 'Clasificadores\\clasificador_5000_capa_dispositivos_param.pkl')
