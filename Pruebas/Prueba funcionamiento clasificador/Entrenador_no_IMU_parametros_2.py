...
# Guardar el scaler
scaler_path = os.path.join(path_out, 'Escaladores\\scaler_5000_no_IMU_8_SIN_CRUZAR_DEDOS.pkl')
...
model_path = os.path.join(path_out, 'Clasificadores\\clasificador_5000_no_IMU_8_SIN_CRUZAR_DEDOS_param.pkl')
